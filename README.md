...
The public GitHub Pages showcase is available at [ches.dev/3D-Printing-Order-Management](https://ches.dev/3D-Printing-Order-Management/). It recreates the customer order modal and the internal Prints and Submissions dashboards with fictional, browser-local data. Demo actions do not connect to the original database or authentication system.
...
*.html              Static GitHub Pages showcase
```
